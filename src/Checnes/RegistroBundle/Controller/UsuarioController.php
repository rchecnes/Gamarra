...
use Checnes\RegistroBundle\Form\UsuarioType;
...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ChecnesRegistroBundle:Usuario')->findAll();

        $data['titulo']   = "Listado de Usuarios";
        $data['entities'] = $entities;

        return $this->render('ChecnesRegistroBundle:Usuario:index.html.twig',$data);
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        return $this->render('ChecnesRegistroBundle:Usuario:show.html.twig', array(
            'entity'      => $entity,
